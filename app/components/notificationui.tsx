...
export default function NotificationShower({
  ...
  return (
    <div
      ref={divRef}
      className='w-[30vw] h-[50vh] overflow-y-scroll bg-[var(--bg-secondary)] flex flex-col justify-start items-center absolute top-[55] right-[5] scrollbar-none rounded-md slide'
    >
      {isLoading ? (
        <Loader />
      ) : (
